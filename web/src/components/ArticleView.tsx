...
export function ArticleView({ article, onClose, onMarkRead, isRead, onToggleRead, onPrev, onNext, onNextUnread }: Props) {
  ...
  return (
    <div className="flex-1 flex flex-col bg-white overflow-hidden">
      {/* Article header */}
      <div className="flex-shrink-0 border-b border-border px-4 py-4 sm:px-6 sm:pt-6 sm:pb-4 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-start">
            <div className="flex flex-wrap items-center gap-1 sm:flex-shrink-0">
              <button
                onClick={onClose}
                className="flex h-8 w-8 items-center justify-center rounded-lg text-text-sub transition-colors hover:bg-bg-alt hover:text-text-primary focus-visible:ring-2 focus-visible:ring-accent focus-visible:outline-none"
            ...
            <h1 className="text-xl font-bold text-text-primary leading-snug flex-1 sm:ml-1">
              {decodedTitle}
            </h1>
          </div>

          {/* Meta info */}
          <div className="flex flex-wrap items-center gap-3 text-sm sm:pl-11">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6 lg:px-8">
        <div
          className="article-view-body max-w-3xl mx-auto sm:pl-11"
